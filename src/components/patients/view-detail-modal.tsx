  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="max-w-[640px] max-h-[90vh] p-0 gap-0 rounded-[16px] overflow-auto"
      >
        {/* Header */}
            ...
            <div className="grid grid-cols-5 gap-2">
              {VITALS_CONFIG.map((v) => {
                ...
                return (
                  <div
                    key={v.key}
                    className="bg-[#f9fafb] rounded-[10px] overflow-hidden"
                  >
                    <div style={{ height: 3, backgroundColor: v.color }} />
                    <div className="px-2 py-2">
                      <p className="text-[11px] font-semibold text-[#9ca3af]">{v.label}</p>
                      <p className="text-[16px] font-bold leading-tight whitespace-nowrap" style={{ color: v.color }}>
                        {value}
                      </p>
